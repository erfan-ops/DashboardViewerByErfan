...
export default function LineChartCanvas({ item, dashboardId, geom, attrs, data }: Props) {
  ...
  const initChart = useCallback((el: HTMLCanvasElement | null) => {
    ...
    const chart = new LineChartItem(item.item_id, dashboardId, item.display_order, geom, attrs, data, ctxRef.current)
